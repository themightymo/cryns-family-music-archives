...
class WP_Email_Template_Style_Fonts_Tab extends WP_Email_Tempate_Admin_UI
{
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array(
			...
			'callback_function'	=> 'wp_email_template_style_fonts_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/style-fonts-settings.php' );
...
global $wp_email_template_style_fonts_tab;
$wp_email_template_style_fonts_tab = new WP_Email_Template_Style_Fonts_Tab();

/**
 * wp_email_template_style_fonts_tab_manager()
 * Define the callback function to show tab content
 */
function wp_email_template_style_fonts_tab_manager() {
	global $wp_email_template_style_fonts_tab;
	$wp_email_template_style_fonts_tab->tab_manager();
}
