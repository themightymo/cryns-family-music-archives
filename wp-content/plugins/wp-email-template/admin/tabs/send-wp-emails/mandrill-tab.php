...
<?php
/*-----------------------------------------------------------------------------------
WP Email Template Send WP Emails Mandrill Provider Tab
...
class WP_ET_Mandrill_Provider_Tab extends WP_Email_Tempate_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wp_et_mandrill_provider_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/send-wp-emails/mandrill-settings.php' );
...
global $wp_et_mandrill_provider_tab;
$wp_et_mandrill_provider_tab = new WP_ET_Mandrill_Provider_Tab();

/** 
 * wp_et_mandrill_provider_tab_manager()
 * Define the callback function to show tab content
 */
function wp_et_mandrill_provider_tab_manager() {
	global $wp_et_mandrill_provider_tab;
	$wp_et_mandrill_provider_tab->tab_manager();
}
